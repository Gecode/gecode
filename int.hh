...
#include "int/int-set.icc"


#include "int/var.icc"
#include "int/view.icc"
#include "int/propagator.icc"
#include "int/array.icc"
...
namespace Gecode {
  ...
  GECODE_INT_EXPORT void 
  gcc(Space* home, const IntVarArgs& x, const IntArgs& c, int m, int unspec,
      int min, int max,
      IntConLevel icl);
  ...
  GECODE_INT_EXPORT void 
  gcc(Space* home, const IntVarArgs& x, const IntArgs& c, int m, 
      int unspec_low, int unspec_up, int min, int max, 
      IntConLevel icl);
   ...
   */
  GECODE_INT_EXPORT void
  gcc(Space* home, const IntVarArgs& x, const IntArgs& v, const IntVarArgs& c, 
