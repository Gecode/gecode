  ...
  if (!pp->hadError) {
    ...
    if (iv_size > 0) {
      ...
      for (size_t i = 0; i < pp->uniform_int.size(); ++i) {
        pp->fg->restart_data().uniform_range_int.emplace_back(pp->uniform_int[i][0], pp->uniform_int[i][1]);
  ...
  if (!pp->hadError) {
    ...
    if (bv_size > 0) {
      ...
      for (size_t i = 0; i < pp->last_val_bool.size(); ++i) {
        ...
        LastValBool::post(*(pp->fg), pp->fg->bv[(pp->last_val_bool[i][0])], i);
      }
  ...
  if (!pp->hadError) {
    ...
    if (sv_size > 0) {
      ...
      for (size_t i = 0; i < pp->last_val_set.size(); ++i) {
        ...
        LastValSet::post(*(pp->fg), pp->fg->sv[(pp->last_val_set[i][0])], i);
      }
  ...
  if (!pp->hadError) {
    ...
    if (fv_size > 0) {
      ...
      for (size_t i = 0; i < pp->last_val_float.size(); ++i) {
        ...
        LastValFloat::post(*(pp->fg), pp->fg->fv[(pp->last_val_float[i][0])], i);
      }
      base += pp->last_val_float.size();

      pp->fg->restart_data().uniform_range_float.reserve(pp->uniform_float.size());
      for (size_t i = 0; i < pp->uniform_float.size(); ++i) {
        pp->fg->restart_data().uniform_range_float.emplace_back(std::get<0>(pp->uniform_float[i]), std::get<1>(pp->uniform_float[i]));
...
#line 636 "gecode/flatzinc/parser.tab.cpp"
...
{
       0,   704,   704,   706,   708,   711,   712,   714,   716,   719,
     720,   722,   724,   727,   728,   735,   738,   740,   743,   744,
     747,   751,   752,   753,   754,   757,   759,   761,   762,   765,
     766,   769,   770,   776,   776,   779,   811,   843,   882,   915,
     924,   934,   943,   955,  1025,  1091,  1162,  1230,  1251,  1271,
    1291,  1314,  1318,  1333,  1357,  1358,  1362,  1364,  1367,  1367,
    1369,  1373,  1375,  1390,  1413,  1414,  1418,  1420,  1424,  1428,
    1430,  1445,  1468,  1469,  1473,  1475,  1478,  1481,  1483,  1498,
    1521,  1522,  1526,  1528,  1531,  1536,  1537,  1542,  1543,  1548,
    1549,  1554,  1555,  1559,  1716,  1730,  1755,  1757,  1759,  1765,
    1767,  1780,  1782,  1791,  1793,  1800,  1801,  1805,  1807,  1812,
    1813,  1817,  1819,  1824,  1825,  1829,  1831,  1836,  1837,  1841,
    1843,  1851,  1853,  1857,  1859,  1864,  1865,  1869,  1871,  1873,
    1875,  1877,  1973,  1988,  1989,  1993,  1995,  2003,  2037,  2044,
    2051,  2077,  2078,  2086,  2087,  2091,  2093,  2097,  2101,  2105,
    2107,  2111,  2113,  2115,  2118,  2118,  2121,  2123,  2125,  2127,
    2129,  2235,  2246
};
#endif
...
#line 780 "./gecode/flatzinc/parser.yxx"
      {
        ParserState* pp = static_cast<ParserState*>(parm);
...
#line 2334 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 2370 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 916 "./gecode/flatzinc/parser.yxx"
      {
        ParserState* pp = static_cast<ParserState*>(parm);
...
#line 2463 "gecode/flatzinc/parser.tab.cpp"
    break;

  case 40: /* vardecl_item: FZ_FLOAT ':' var_par_id annotations '=' non_array_expr  */
#line 925 "./gecode/flatzinc/parser.yxx"
      {
        ParserState* pp = static_cast<ParserState*>(parm);
...
#line 2477 "gecode/flatzinc/parser.tab.cpp"
    break;

  case 41: /* vardecl_item: FZ_BOOL ':' var_par_id annotations '=' non_array_expr  */
#line 935 "./gecode/flatzinc/parser.yxx"
      {
        ParserState* pp = static_cast<ParserState*>(parm);
...
#line 2506 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 957 "./gecode/flatzinc/parser.yxx"
      {
        ParserState* pp = static_cast<ParserState*>(parm);
...
#line 2579 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 2648 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 2721 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 1164 "./gecode/flatzinc/parser.yxx"
      {
        ParserState* pp = static_cast<ParserState*>(parm);
        bool print = (yyvsp[-1].argVec) != NULL && (yyvsp[-1].argVec)->hasCall("output_array");
...
#line 2792 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 2816 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 2839 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 2886 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 2913 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 2993 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 3072 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 3096 "gecode/flatzinc/parser.tab.cpp"
    break;

  case 72: /* bool_init_list: %empty  */
#line 1468 "./gecode/flatzinc/parser.yxx"
      { (yyval.varSpecVec) = new vector<VarSpec*>(0); }
#line 3102 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 3151 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 3175 "gecode/flatzinc/parser.tab.cpp"
    break;

  case 80: /* set_init_list: %empty  */
#line 1521 "./gecode/flatzinc/parser.yxx"
      { (yyval.varSpecVec) = new vector<VarSpec*>(0); }
#line 3181 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 1538 "./gecode/flatzinc/parser.yxx"
...
#line 1542 "./gecode/flatzinc/parser.yxx"
      { (yyval.oVarSpecVec) = Option<vector<VarSpec*>* >::none(); }
...
#line 3413 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 3431 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 3466 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 1783 "./gecode/flatzinc/parser.yxx"
...
#line 3544 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 1814 "./gecode/flatzinc/parser.yxx"
      { (yyval.setValue) = (yyvsp[-1].setValue); }
#line 3556 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 1824 "./gecode/flatzinc/parser.yxx"
...
#line 3646 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 3670 "gecode/flatzinc/parser.tab.cpp"
    break;

  case 130: /* non_array_expr: set_literal  */
#line 1876 "./gecode/flatzinc/parser.yxx"
...
#line 1994 "./gecode/flatzinc/parser.yxx"
      { (yyval.argVec) = new AST::Array((yyvsp[0].arg)); }
...
#line 3865 "gecode/flatzinc/parser.tab.cpp"
    break;

  case 139: /* solve_expr: FZ_FLOAT_LIT  */
#line 2045 "./gecode/flatzinc/parser.yxx"
      {
        ParserState *pp = static_cast<ParserState*>(parm);
        pp->intvars.push_back(varspec("OBJ_CONST_INTRODUCED",
          new IntVarSpec(0,true,false)));
...
#line 3876 "gecode/flatzinc/parser.tab.cpp"
    break;

  case 140: /* solve_expr: var_par_id '[' FZ_INT_LIT ']'  */
#line 2052 "./gecode/flatzinc/parser.yxx"
      {
        SymbolEntry e;
        ParserState *pp = static_cast<ParserState*>(parm);
...
#line 2088 "./gecode/flatzinc/parser.yxx"
      { (yyval.argVec) = (yyvsp[0].argVec); }
#line 3916 "gecode/flatzinc/parser.tab.cpp"
    break;

  case 145: /* annotations_head: FZ_COLONCOLON annotation  */
#line 2092 "./gecode/flatzinc/parser.yxx"
      { (yyval.argVec) = new AST::Array((yyvsp[0].arg)); }
#line 3922 "gecode/flatzinc/parser.tab.cpp"
    break;
...
#line 2098 "./gecode/flatzinc/parser.yxx"
      {
...
#line 4106 "gecode/flatzinc/parser.tab.cpp"
    break;

  case 161: /* ann_non_array_expr: var_par_id '[' ann_non_array_expr ']'  */
#line 2236 "./gecode/flatzinc/parser.yxx"
      {
        ParserState* pp = static_cast<ParserState*>(parm);
        int i = -1;
        yyassert(pp, (yyvsp[-1].arg)->isInt(i), "Non-integer array index");
...
#line 4121 "gecode/flatzinc/parser.tab.cpp"
    break;

  case 162: /* ann_non_array_expr: FZ_STRING_LIT  */
#line 2247 "./gecode/flatzinc/parser.yxx"
      {
        (yyval.arg) = new AST::String((yyvsp[0].sValue));
        free((yyvsp[0].sValue));
      }
#line 4130 "gecode/flatzinc/parser.tab.cpp"
    break;
