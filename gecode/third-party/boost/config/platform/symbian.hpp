...
#define GECODE_BOOST_PLATFORM "Symbian"
#define GECODE_BOOST_SYMBIAN 1


#if defined(__S60_3X__)
// Open C / C++ plugin was introdused in this SDK, earlier versions don't have CRT / STL
#  define GECODE_BOOST_S60_3rd_EDITION_FP2_OR_LATER_SDK
...
#  ifndef GECODE_BOOST_HAS_STDINT_H
...
#  endif
#  ifndef GECODE_BOOST_POSIX_API
#    define GECODE_BOOST_POSIX_API
#  endif
// endianess support
...
#  define GECODE_BOOST_DATE_TIME_NO_LOCALE
#  define GECODE_BOOST_NO_STD_WSTRING
#  define GECODE_BOOST_EXCEPTION_DISABLE
...
#if defined(__WINSCW__) && !defined(GECODE_BOOST_DISABLE_WIN32)
#  define GECODE_BOOST_DISABLE_WIN32 // winscw defines WIN32 macro
#endif
