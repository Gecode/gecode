...
#define GECODE_BOOST_PLATFORM "Mac OS"
...
#  if !defined(GECODE_BOOST_HAS_PTHREADS)
// MPTasks support is deprecated/removed from Boost:
//#    define GECODE_BOOST_HAS_MPTASKS
...
#ifdef GECODE_BOOST_HAS_PTHREADS
#  define GECODE_BOOST_HAS_THREADS
#endif

// The remote call manager depends on this.
#    define GECODE_BOOST_BIND_ENABLE_PASCAL
