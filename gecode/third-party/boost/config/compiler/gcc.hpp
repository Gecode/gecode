...
#   if __GNUC_MINOR__ < 95
      ...
      // work - define GECODE_BOOST_MSVC6_MEMBER_TEMPLATES
...
#if !defined(__EXCEPTIONS) && !defined(GECODE_BOOST_NO_EXCEPTIONS)
...
#    define GECODE_BOOST_SYMBOL_EXPORT __attribute__((dllexport))
#    define GECODE_BOOST_SYMBOL_IMPORT __attribute__((dllimport))
#  else
#    define GECODE_BOOST_SYMBOL_EXPORT __attribute__((visibility("default")))
#    define GECODE_BOOST_SYMBOL_IMPORT
#  endif
#  define GECODE_BOOST_SYMBOL_VISIBLE __attribute__((visibility("default")))
#else
...
#  ifndef __GXX_RTTI
#     ifndef GECODE_BOOST_NO_TYPEID
#        define GECODE_BOOST_NO_TYPEID
#     endif
#     ifndef GECODE_BOOST_NO_RTTI
...
// scoped enums have a serious bug in 4.4.0, so define GECODE_BOOST_NO_SCOPED_ENUMS before 4.5.1
...
#  define GECODE_BOOST_COMPILER "GNU C++ version " __VERSION__
#endif

// ConceptGCC compiler:
//   http://www.generic-programming.org/software/ConceptGCC/
#ifdef __GXX_CONCEPTS__
#  define GECODE_BOOST_HAS_CONCEPTS
#  define GECODE_BOOST_COMPILER "ConceptGCC version " __VERSION__
#endif
