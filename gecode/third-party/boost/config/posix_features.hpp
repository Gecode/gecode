...
#  if defined(GECODE_BOOST_HAS_UNISTD_H)
#     include <unistd.h>
...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(GECODE_BOOST_HAS_WINTHREADS) && !defined(GECODE_BOOST_HAS_MPTASKS)
#        define GECODE_BOOST_HAS_PTHREADS
#     endif

      // GECODE_BOOST_HAS_NANOSLEEP:
...
#     endif
      ...
      // GECODE_BOOST_HAS_CLOCK_GETTIME:
...
#     endif
      ...
      // GECODE_BOOST_HAS_GETTIMEOFDAY:
      // GECODE_BOOST_HAS_PTHREAD_MUTEXATTR_SETTYPE:
