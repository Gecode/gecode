...
- [ ] The baseline and candidate first choices are recorded for the exact alternating-variable microcase.
- [ ] Width-64 span calculation and all merit denominators are overflow- and zero-safe.
- [ ] Twenty interleaved Release trials report root-choice scan time for the microcase and solutions, nodes, failures, propagations, and runtime for the DMA model and compact controls.
- [ ] The result is either a justified retained merit or a clean rejection with no prototype code left.
