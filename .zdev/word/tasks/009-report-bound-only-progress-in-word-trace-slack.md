...
- [ ] A pure bound-only update decreases bounded trace slack monotonically and reports nonzero progress.
- [ ] Assignment has zero slack and full-width bounded construction has the expected finite saturated slack.
- [ ] Width-one, width-64, signed, unsigned, bit-only, and combined-domain trace cases remain correct.
